...
%DIF DEL Haiti_agu_revised_1.tex   Fri Aug 17 03:52:43 2018
%DIF ADD Haiti_agu_revised_2.tex   Fri Aug 17 03:45:12 2018
...
\label{sec:intro}
On January 12, 2010, a $M_w$ 7.0 earthquake struck the densely populated, greater Port-au-Prince region of south-central Haiti and caused widespread destruction with over 230,000 fatalities and an estimated 10 billion dollars damage \citep{prentice2010seismic,bilham2010lessons,paultre2013damage,kocel2016near} (Figure~\ref{figure1}). Multidisciplinary, geological and geophysical studies \DIFdelbegin \DIFdel{about }\DIFdelend \DIFaddbegin \DIFadd{within }\DIFaddend the 2010 epicentral area of south-central Haiti \DIFdelbegin \DIFdel{have been done, including}\DIFdelend \DIFaddbegin \DIFadd{include}\DIFaddend : 1) \DIFaddbegin \DIFadd{measurements and fault modeling of }\DIFaddend coseismic, coral reef uplift \DIFdelbegin \DIFdel{observation }\DIFdelend along a 50 km-long area of coastline in the epicentral region \DIFdelbegin \DIFdel{combined with fault modeling }\DIFdelend \citep{hayes2010complex}; 2) coseismic, vertical ground motion from radar interferometry \citep{hashimoto2011fan}; 3) high-resolution, surface-fault-trace mapping using Light Detection And Ranging (LIDAR) and targeted field studies \citep{cowgill2012interactive}; 4) Global Positioning System (GPS) and 2010 aftershock-based studies and modeling of pre-, syn-, and post-2010 earthquake crustal motions \citep{calais2010transpressional,nettles2010earthquake,symithe2013coseismic,douilly2013crustal,douilly2015three}; 5) ground-based studies of Holocene scarps including coseismic ground fractures and late Quaternary scarps of the EPGFZ that remained unaffected by 2010 fault breaks \citep{prentice2010seismic,koehler2011field,rathje2014geotechnical,saint2015seismotectonics}; 6) ground-based, near-surface, geophysical surveys of buried faults activated during the 2010 earthquake \citep{kocel2016near}; 7) near-coast surveys of submarine extensions of faults active in 2010 \citep{hornbach2010high,mercier20112010}; and 8) deepwater, marine surveys and coring to determine the recurrence interval of major earthquakes based on anomalous sedimentary deposits related to shaking and increased erosion \citep{mchugh2011offshore}. The consensus from these previous, on- and offshore, multidisciplinary studies is that the 2010 earthquake ruptured two, previously unrecognized west- to northwest-striking thrust faults located 2 to 5 km north of the 1200 km-long, left-lateral, Enriquillo-Plantain Garden fault zone (EPGFZ) that forms a major, plate boundary between the Caribbean plate to the south and the Gon\^ave microplate to the north \citep{mann1995actively,calais2010transpressional,benford2012gps,corbeau2016transpressive} (Figure~\ref{figure1}A, B). These two thrusts are separated by 6 km and include: 1) the subaerial, 8 km-long, blind, L\'eog\^ane thrust fault located 5 km north of the EPGFZ and trending at an angle of $8^{\circ}$ to the EPGFZ \citep{calais2010transpressional,douilly2013crustal,douilly2015three}; and 2) the submarine, 20 km-long Trois Baies thrust fault located 2 km north of the EPGFZ and trending at an angle of $20^{\circ}$ \DIFaddbegin \DIFadd{to the EPGFZ }\DIFaddend \citep{mercier20112010,symithe2013coseismic} (Figure~\ref{figure1}B, C).

Despite the proximity of the L\'eog\^ane and Trois Baies thrust to the neighboring EPGFZ, the EPGFZ remained largely quiescent and outside the zone of maximum, coseismic uplift and ground shaking and aftershocks related to the 2010 earthquake \citep{nettles2010earthquake}. The centroid moment tensor (CMT) mechanism of the main 2010 shock shows a primarily strike-slip motion, with a small component of reverse motion, on a steeply north-dipping nodal plane \citep{nettles2010earthquake,douilly2013crustal}. Finite element modeling \citep{douilly2015three} suggests that L\'eog\^ane fault\DIFaddbegin \DIFadd{, that is }\DIFaddend buried beneath at least 1 km of overlying undeformed clastic sediment in the area north of the EPGFZ\DIFaddbegin \DIFadd{, }\DIFaddend absorbed most of the energy of the northeast-southwest compression along obliquely-striking, high-angle ($21^{\circ}$-$70^{\circ}$ dipping) reverse fault planes. For this reason, there was insufficient stress to trigger slip during the 2010 earthquake on the \DIFaddbegin \DIFadd{more east-west-striking }\DIFaddend EPGFZ 5 km to the south (Figure \ref{figure1}B). Previous GPS surveys \citep{calais2010transpressional,calais2016plate} along this area of the EPGFZ display vectors at almost right angles to these obliquely-striking thrusts and consistent with their preferred \DIFdelbegin \DIFdel{reactivation }\DIFdelend \DIFaddbegin \DIFadd{orientation for reactivation within the area of northeast-to-southwest shortening }\DIFaddend (Figure \ref{figure1}A, B).

Aftershock studies following the 2010 earthquake by \citet{douilly2013crustal,douilly2015three} showed that the EPGFZ moved \DIFdelbegin \DIFdel{slightly }\DIFdelend \DIFaddbegin \DIFadd{locally }\DIFaddend at depth and acted as a 6 km-long, east-west and sub-vertical, connecting fault segment that transmitted seismogenic motion between the obliquely-trending, north-dipping, L\'eog\^ane fault in the east and the more obliquely-trending, southwest-dipping Trois Baies fault in the west (Figure \ref{figure1}B). However, post-earthquake geologic reconnaissance revealed no surface ground breaks along the proposed onland areas of EPGFZ in the epicentral region of the earthquake \citep{prentice2010seismic,koehler2011field,rathje2014geotechnical}. A more recent study by \citet{saint2015seismotectonics} proposed previously, unrecognized, 2010 coseismic groundbreaks along the obliquely-trending Lamentin thrust 11 km east of the epicentral area near the city of Port-au-Prince (Figure \ref{figure2}A).

\textit{En~echelon} thrusts spacing at distances of 1-8 km along the main strike-slip fault, obliquely intersect the main strike-slip fault at angles of $30^{\circ}$ -- $45^{\circ}$. These structures strike northwestward away from the EPGFZ \DIFdelbegin \DIFdel{with individual oblique, fault lengths extending into the deeper basins at }\DIFdelend distances of 4-29 km \DIFaddbegin \DIFadd{into the more thickly-sedimented basinal areas north of the EPGFZ }\DIFaddend (Figure~\ref{figure2}A).  As a result of this distinctive and regular intersecting fault geometry between these oblique thrusts and the linear EPGFZ, earthquake rupture initiating on an oblique thrust, as seen for the L\'eog\^ane fault in 2010, is likely confined to that vicinity and may not connect with other oblique thrusts or even the EPGFZ itself \citep{douilly2013crustal,douilly2015three}.

Coseismic deformation along a large transpressional strike-slip fault, such as the EPGFZ \citep{calais2002strain} in Hispaniola or the San Andreas fault zone in California \citep{segall1990surface}, \DIFdelbegin \DIFdel{either is }\DIFdelend \DIFaddbegin \DIFadd{is either }\DIFaddend accommodated by slip and major earthquakes on the main, strike-slip plate boundary fault, or is accommodated by the oblique, \textit{en~echelon} thrusts adjacent to the main fault, or is accommodated by both sets of faults (cf. compilation of types of destructive earthquakes in transpressional settings by \citet{hayes2010complex}). Motions on distributed, \textit{en~echelon} thrusts do not necessarily spare or reduce coseismic rupture on the main strike-slip fault because the \textit{en~echelon} and main strike-slip fault remain separate fault planes, and the main strike-slip fault \DIFdelbegin \DIFdel{could }\DIFdelend \DIFaddbegin \DIFadd{would }\DIFaddend continue to accumulate strain. In an extreme case, plate motions become increasingly transpressional as seen in the case of the EPGFZ \DIFdelbegin \DIFdel{as manifested in the obliquity of GPS vectors relative to the strike of the EPGFZ }\DIFdelend \DIFaddbegin \DIFadd{either }\DIFaddend (Figure~\ref{figure1}A, B)\DIFdelbegin \DIFdel{or in a restraining bend setting or during the plate reorganizations. In these settings}\DIFdelend \DIFaddbegin \DIFadd{. In such a setting}\DIFaddend , the \textit{en~echelon}, oblique thrusts might assume more and more plate-edge strain to the point that the plate boundary behaves more like a broad, thrust boundary and less like a narrow, strike-slip boundary \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{mount1987state}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend .

These oblique and \textit{en~echelon} thrust faults in transpressional settings, \DIFdelbegin \DIFdel{including }\DIFdelend \DIFaddbegin \DIFadd{that includes }\DIFaddend large restraining bends \DIFdelbegin \DIFdel{as in }\DIFdelend \DIFaddbegin \DIFadd{such as }\DIFaddend Hispaniola, potentially nucleate ``uncharacteristic earthquakes'' of varying recurrence intervals and sizes that are distinct from the recurrence intervals and sizes of the adjacent but independent strike-slip fault \citep{Fielding2013}. Restraining bend areas like Hispaniola can lead to the generation and increased activities on more favorably and obliquely oriented folds and thrusts whose coseismic rupture might alternate with much longer ruptures along the adjacent strike-slip fault. The number of these \textit{en~echelon} thrust faults \DIFdelbegin \DIFdel{, in restraining bend setting, }\DIFdelend can be large at observed spacings of 5-10 km dispersed along the trend of strike-slip faults that may be hundreds of kilometers in total length. For this reason, the identification \DIFaddbegin \DIFadd{and earthquake potential }\DIFaddend of oblique \textit{en~echelon} thrusts, especially when buried or ``blind'', can be challenging \DIFdelbegin \DIFdel{, assessing their role with seismogenesis within a broad plate boundary }\DIFdelend \DIFaddbegin \DIFadd{to assess in transpressional zones }\DIFaddend \citep{frankel2011seismic}.

\section{Objectives and methods}
\subsection{Study area}
\DIFdelbegin \DIFdel{This }\DIFdelend \DIFaddbegin \DIFadd{The }\DIFaddend elongate, belt of transpressional deformation associated with \textit{en~echelon} thrusts occupies a topographically-low, densely populated Cul-de-Sac basin underlain by \DIFdelbegin \DIFdel{poorly consolidated }\DIFdelend \DIFaddbegin \DIFadd{poorly-consolidated, }\DIFaddend clastic sedimentary rocks ranging in age from Miocene to Recent \citep{massoni1955haiti,mann1995actively,terrier2014revision,saint2015seismotectonics}. In easternmost Haiti, this belt is overlain by the \DIFdelbegin \DIFdel{the }\DIFdelend shallow (33 m-deep), 138 km\textsuperscript{2}, brackish Lake Azuey near the border separating Haiti from the Dominican Republic \citep{wright2015factors,piasecki2016bathymetric}. Lake Enriquillo to the east is \DIFdelbegin \DIFdel{a larger}\DIFdelend \DIFaddbegin \DIFadd{twice as large (346 km \textsuperscript{2})}\DIFaddend , shallow (52 m-deep), \DIFdelbegin \DIFdel{346 km\textsuperscript{2}, hypersaline, sub-sealevel lake }\DIFdelend \DIFaddbegin \DIFadd{hypersaline, about 40 m below sealevel, and }\DIFaddend located entirely in the Dominican Republic and separated from Lake Azuey by the eastward continuation of the same transpressional belt parallel and north of the EPGFZ in the Cul-de-Sac valley \citep{mann1995actively} (Figure \ref{figure1}B). 

In the western part of our study area, the more transtensional segment of the EPGFZ is overlain by the \DIFdelbegin \DIFdel{the }\DIFdelend 42.8 m-deep, 14 km\textsuperscript{2}, freshwater Lake Mirago\^ane (Figure \ref{figure1}B). All three of these shallow, inland, lakes experience variations up to 13 m in their surface elevations due to annual to decadal changes in climate and rainfall amounts including extreme rainfall \DIFaddbegin \DIFadd{events }\DIFaddend associated with hurricanes \citep{wright2015factors,piasecki2016bathymetric,moknatian2017development,rico2017hydrodynamic}.  

\subsection{Objectives}
The main goal of this paper \DIFdelbegin \DIFdel{are }\DIFdelend \DIFaddbegin \DIFadd{is }\DIFaddend to better integrate the geologic structure of the 120 km-long study area, which parallels the trace of the EPGFZ and includes the 2010 epicentral area, using \DIFdelbegin \DIFdel{a wealth of geologic}\DIFdelend \DIFaddbegin \DIFadd{data types that include geology}\DIFaddend , geophysics, GPS, radar interferometry, \DIFdelbegin \DIFdel{aftershock}\DIFdelend \DIFaddbegin \DIFadd{aftershocks}\DIFaddend , and modeling studies\DIFdelbegin \DIFdel{, most of which has been collected since the }\DIFdelend \DIFaddbegin \DIFadd{. Most of these studies were completed in the aftermath of the }\DIFaddend 2010 earthquake. Our \DIFdelbegin \DIFdel{primary objective is to use these information }\DIFdelend \DIFaddbegin \DIFadd{study integrates these datasets in order }\DIFaddend to structurally characterize the 10-15 km-wide, belt of late Holocene, transpressional deformation that forms a laterally-extensive, deformed belt along the inland, Cul-de-Sac intermontane basin in the east and the low-relief coastal plain along Port-au-Prince bay and the Canal du Sud to the west (Figure~\ref{figure1}B). In particular, we focus on the identifying a family of \textit{en~echelon} thrusts, whose curvilinear strikes area are very similar to the L\'eog\^ane thrust now known to be responsible for most of the energy release and coseismic uplift during the 2010 Haiti earthquake \citep{calais2010transpressional,douilly2013crustal,douilly2015three} (Figure \ref{figure1}B, Figure \ref{figure2}A).

\subsection{Survey design}
In order to understand the geologic and structural styles of transpression within this belt, including the age relations between deformation in the north-flanking belt and the EPGFZ itself, we collected a total of 94 km of high-resolution (2-10 kHz) sonar profiles in 2014 from the 138 km\textsuperscript{2}, brackish Lake Azuey and 37 km of profiles from the 14 km\textsuperscript{2}, fresh-water Lake Mirago\^ane (Figure~\ref{figure1}B). The EPGFZ strikes through both of the lakes, so 80\% of our lines on Lake Azuey and 90\% of our survey lines on Lake Mirago\^ane \DIFdelbegin \DIFdel{was }\DIFdelend \DIFaddbegin \DIFadd{were }\DIFaddend dedicated to the across fault-strike, north-south profiles. 

The average speed of the boat towing the sonar was 3 knots, \DIFdelbegin \DIFdel{and we used }\DIFdelend \DIFaddbegin \DIFadd{with }\DIFaddend a sonar pulse rate of 4 per second. Our 2-10 kHz sonar frequency range \DIFdelbegin \DIFdel{gives }\DIFdelend \DIFaddbegin \DIFadd{yielded }\DIFaddend sub-bottom layer resolution of about 10 cm. These surveys were the first sonar surveys in Haitian lakes. Both lakes straddle the projected active trace of Haiti's EPGFZ and its adjacent, transpressional fold-thrust belt, \DIFaddbegin \DIFadd{and }\DIFaddend therefore provide new constraints on the location, structural style, and timing of deformation within both structural provinces. We \DIFdelbegin \DIFdel{incorporate }\DIFdelend \DIFaddbegin \DIFadd{integrate }\DIFaddend these lake data with previous geologic mapping, geophysical observations related to the 2010 earthquake, and regional information on plate motions in this region\DIFdelbegin \DIFdel{(Figure~\ref{figure1}B)}\DIFdelend . 
...
The first is the strike-slip-dominated model, driven by oblique motion and transpression between the thick and buoyant Bahamas platform on the North America plate, the Caribbean plate, and the Gon\^ave microplate \citep{mann1995actively,dolan1998active,mann2002oblique,calais2002strain,calais2016plate} (Figure~\ref{figure1}A, B). \DIFdelbegin \DIFdel{Structures and tectonic geomorphology formed in }\DIFdelend \DIFaddbegin \DIFadd{GPS surveys within }\DIFaddend this 250 km-wide, transpressional zone \DIFdelbegin \DIFdel{include: GPS studies }\DIFdelend \citep{calais2002strain,calais2010transpressional,hayes2010complex,symithe2013coseismic,douilly2013crustal,douilly2015three} reveal strain partitioning along the EPGFZ and the subparallel Septentrional strike-slip fault zone \DIFaddbegin \DIFadd{200 km to the north }\DIFaddend (which is the plate boundary \DIFdelbegin \DIFdel{between }\DIFdelend \DIFaddbegin \DIFadd{separating the }\DIFaddend North Hispaniola microplate and Gon\^ave microplate) (Figure {\ref{figure1}}A). As a result of transpression, the \DIFdelbegin \DIFdel{central Hispaniola }\DIFdelend \DIFaddbegin \DIFadd{3-km-high mountains of central Hispaniola form the highest topography in the northern Caribbean region. Hispaniola }\DIFaddend has the highest topography, up to 3 km, in all of the northern Caribbean region. The left-lateral strike-slip rupture of the EPGFZ in the 18th century inferred from \DIFaddbegin \DIFadd{the map pattern of }\DIFaddend historical earthquakes \citep{bakun2012significant} \DIFdelbegin \DIFdel{with average }\DIFdelend \DIFaddbegin \DIFadd{combined with average late Holocene, }\DIFaddend left-lateral offset amounts of 1.3 -- 3.3 m as expressed along offset streams of the EPGFZ \citep{prentice2010seismic} and by \DIFaddbegin \DIFadd{late Holocene, }\DIFaddend left-lateral, channel offsets of 7 -- 8 m along stream channels \DIFaddbegin \DIFadd{offset }\DIFaddend by the Septentrional fault zone \citep{prentice1993paleoseismicity,leroy2015segmentation}. \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citet{saint2015seismotectonics}}\hspace{0pt}%DIFAUXCMD
's study indicates }\DIFdelend \DIFaddbegin \DIFadd{The study by \mbox{%DIFAUXCMD
\citet{saint2015seismotectonics} }\hspace{0pt}%DIFAUXCMD
indicates that }\DIFaddend the folding and thrusting of 10 -- 15 km-wide belt of Miocene to Quaternary rock \DIFdelbegin \DIFdel{adjacent to }\DIFdelend \DIFaddbegin \DIFadd{was generated by transpression along }\DIFaddend the EPGFZ. In addition, \citet{mann2002oblique,grindlay2005high,kroehler2011late} suggest a strong, southwestward, backthrusting of the \DIFdelbegin \DIFdel{Gon\^ave microplate, in }\DIFdelend southern Hispaniola in Haiti and Dominican Republic to the southwest onto the Caribbean plate (Figure \ref{figure1}B, C). Southwestward backthrusting of Hispaniola is manifested by the accretionary wedges present along the Muerto trench south of the Dominican Republic \citep{bien1986contribution,bruna2009morphotectonics} (Figure \ref{figure1}\DIFaddbegin \DIFadd{A, }\DIFaddend B) and along the southern margin of Haiti (South Haiti accretionary prism \citep{bien1986contribution} (Figure \ref{figure1}C)\DIFdelbegin \DIFdel{, along with the associated, }\DIFdelend \DIFaddbegin \DIFadd{. A }\DIFaddend localized, negative gravity anomaly \DIFdelbegin \DIFdel{associated with plate flexure under a thrust load }\DIFdelend \DIFaddbegin \DIFadd{marks the trend of plate flexure of the underthrusting Caribbean plate beneath the overriding area of southern Hispaniola }\DIFaddend \citep{mann2002oblique,bruna2009morphotectonics} (Figure \ref{figure1}A)).

\subsubsection{Criticisms of the strike-slip, regional structural model}
Two criticisms have been proposed for the strike-slip model. First, \citet{corbeau2016transpressive} \DIFdelbegin \DIFdel{has questioned whether }\DIFdelend \DIFaddbegin \DIFadd{noted that }\DIFaddend the predictions of the GPS-based block models \DIFdelbegin \DIFdel{, which predict significant shortening, are accurate in that little }\DIFdelend \DIFaddbegin \DIFadd{overestimate the observed amounts of }\DIFaddend transpression-related shortening \DIFdelbegin \DIFdel{can be observed from regional seismic }\DIFdelend \DIFaddbegin \DIFadd{seen on seismic reflection }\DIFaddend profiles in the offshore area of the Gulf of Gon\^ave north of the southern peninsula of Haiti, or in the area of the Jamaica Passage east of Haiti. Second, \citet{symithe2016present} have proposed that there is no geologic evidence for a continuation of the EPGFZ east of latitude $72.27^{\circ}$W in the eastern Cul-de-Sac Valley, Lake Azuey and Lake Enriquillo in the Dominican Republic (Figure~\ref{figure1}B). Instead, \citet{symithe2016present} propose that \DIFdelbegin \DIFdel{large }\DIFdelend \DIFaddbegin \DIFadd{the high }\DIFaddend rates of north-south shortening predicted from GPS block models \DIFdelbegin \DIFdel{is taken up }\DIFdelend \DIFaddbegin \DIFadd{are accommodated }\DIFaddend entirely by low-angle thrust structures in the eastern Cul-de-Sac and Enriquillo Valleys that were modeled using GPS data as part of their study.

\subsubsection{Trans-Haitian fold-and-thrust belt regional structural model}
The Trans-Haitian fold-and-thrust belt model originated with a study by \citet{pubellier2000plate}, who proposed a low-angle southwestward-verging fold-and-thrust belt along the southwestern edge of the central Hispaniola block. The thrust front of this feature was thought to be actively propagating from the main Trans-Haitian fold-and-thrust belt, \DIFaddbegin \DIFadd{that is }\DIFaddend located in the Cha\^ine des Matheux (Figure~\ref{figure1}B, Figure~\ref{figure2}A), southwestward into the area of the L\'eog\^ane plain and the Cul-de-Sac basin (Figure \ref{figure2}A, B). \citet{pubellier2000plate} proposed that the EPGFZ originally formed as a left-lateral strike-slip fault, but became inactive in the late Miocene when deformation in southern Hispaniola became \DIFdelbegin \DIFdel{compressional and }\DIFdelend \DIFaddbegin \DIFadd{Increasing compression caused }\DIFaddend the Trans-Haitian fold-and-thrust belt \DIFdelbegin \DIFdel{had propagated }\DIFdelend \DIFaddbegin \DIFadd{to propagate }\DIFaddend into the southern area of the Cul-de-Sac basin and L\'eog\^ane plain, where it emerged or ``daylighted'' to form the \textit{en~echelon}, convergent structures (compiled on the map in Figure \ref{figure2}). \citet{pubellier2000plate} also proposed that the EPGFZ was reactivated as a normal fault in the Quaternary as a result of crustal loading of the southern, foreland area by the overthrusting Trans-Haitian fold-and-thrust belt. 

Following the 2010 earthquake and the recognition of the north-dipping blind L\'eog\^ane thrust fault, \citet{calais2010transpressional} proposed that \DIFdelbegin \DIFdel{this fault is }\DIFdelend the \DIFaddbegin \DIFadd{L\'eog\^ane fault marks the }\DIFaddend leading edge of the Trans-Haitian fold-and-thrust belt rather than being an \textit{en~echelon} thrust genetically linked to the EGPFZ. In the interpretation proposed by \citet{calais2010transpressional}, the northward dip of the L\'eog\^ane thrust made it difficult to link its origin with the EPGFZ, whose dip had been established in this area as a vertical to high angle (> $60^{\circ}$), south-dipping fault plane with evidence of late Holocene, left-lateral offsets of drainages \citep{prentice2010seismic}. Moreover, \citet{symithe2016present} noted that Trans-Haitian fold-and-thrust belt regional model of \citet{pubellier2000plate} was more consistent with \DIFdelbegin \DIFdel{an increasing amount of GPS data supportive of a }\DIFdelend \DIFaddbegin \DIFadd{GPS data showing }\DIFaddend larger magnitude, north-south shortening in central Hispaniola than with the existence of an eastward extension of the left-lateral EPGFZ into the eastern part of Haiti and the Dominican Republic (Figure~\ref{figure1}B and Figure~\ref{figure2}A).
...
A similar pattern of deformation is observed in Port-au-Prince urban area where the central and northern edge of the Cul-de-Sac basin is \DIFdelbegin \DIFdel{almost undeformed }\DIFdelend \DIFaddbegin \DIFadd{only gently folded and faulted }\DIFaddend \citep{massoni1955haiti,cox2011shear,mchugh2011offshore,saint2015seismotectonics} (Line B-B' in Figure~\ref{figure3}). The cross section taken from workers, who were mapping 60 years ago when \DIFdelbegin \DIFdel{the city }\DIFdelend \DIFaddbegin \DIFadd{Port-au-Prince }\DIFaddend was smaller and the geology was less obscured by urbanization, shows two large thrusts, a range-bounding thrust along the southern edge of the city, and a northeast-dipping thrust, the Dumay thrust, that elevates a broad outcrop zone of north-dipping, Neogene sedimentary rocks on which the northern part of \DIFdelbegin \DIFdel{the city }\DIFdelend \DIFaddbegin \DIFadd{Port-au-Prince }\DIFaddend is built \citep{rathje2014geotechnical}. The $50^{\circ}$ northeast dip of the Dumay thrust is similar to the $70^{\circ}$ northeast dip of the L\'eog\^ane thrust to the west known from aftershocks \citep{douilly2013crustal,douilly2015three}, although the dip of the Dumay thrust reverses to a southwest dip as it approaches the EPGFZ (Figure~\ref{figure2}A, B). 
\DIFaddbegin 

\DIFaddend On the cross section B--B' in Figure~\ref{figure3}, we have schematically indicated areas that are elevated as a result of the northward dip of the Dumay thrust and the depression of the area to the south of the EPGFZ in the highlands south of the EPGFZ. If a future earthquake occurred along the north-dipping, \textit{en~echelon} thrust faults in the Port-au-Prince area (Line B--B' in Figure~\DIFdelbegin \DIFdel{\ref{figure3}}\DIFdelend \DIFaddbegin \DIFadd{\ref{figure2}}\DIFaddend ) or Lake Azuey area (Line C--C' in Figure~\DIFdelbegin \DIFdel{\ref{figure3}}\DIFdelend \DIFaddbegin \DIFadd{\ref{figure2}}\DIFaddend ) a similar uplift phenomenon \DIFdelbegin \DIFdel{probably would }\DIFdelend \DIFaddbegin \DIFadd{is likely to }\DIFaddend occur where the lowlands are uplifted and the adjacent mountains subside.

\subsubsection{Geologic structure of the Lake Azuey area} 
In the Lake Azuey area, we mapped a linear\DIFaddbegin \DIFadd{, 250--500 m-wide, }\DIFaddend and east-west striking fault trace in deformed Holocene sediments along the projected trend of the landward traces of the EPGFZ both east and west of Lake Azuey (Figure~\DIFdelbegin \DIFdel{\ref{figure5} }\DIFdelend \DIFaddbegin \DIFadd{\ref{figure4} }\DIFaddend and Figure~\DIFdelbegin \DIFdel{\ref{figure6}A , B). }\DIFdelend \DIFaddbegin \DIFadd{\ref{figure5}A -- D). The fault varies in width from 350 to 500 m but is marked by a graben-like feature that disrupts the uppermost lake stratigraphy. }\DIFaddend Integrated with previous land mapping of the EPGFZ \citep{bourgueil1988synthese,mann1995actively,prentice2010seismic,cowgill2012interactive}, we interpret this linear east-west striking feature in Lake Azuey as a \DIFdelbegin \DIFdel{5 }\DIFdelend \DIFaddbegin \DIFadd{250--500 }\DIFaddend m-wide and continuous trace of the EPGFZ which we can follow westward to the EPGFZ locality at Dumay, about half way between Lake Azuey and Port-au-Prince, which was previously described and dated as a 6 m-long, left-lateral offset of a late Holocene stream channel \citep{cowgill2012interactive} (locates at red circle, which is labeled as Dumay in Figure~\ref{figure2}A). 
\DIFaddbegin 

\DIFaddend The structural cross sections in this area taken from \DIFdelbegin \DIFdel{the }\DIFdelend previous studies \citep{massoni1955haiti,mann1995actively,douilly2015three} \DIFaddbegin \DIFadd{and }\DIFaddend indicate that the high-angle EPGFZ co-exists with the adjacent thrusts that over-thrust from the south and north (Line B--B' in Figure~\ref{figure3}). We project this trace of the EPGFZ along a prominent fault valley at the town of Jimani that separates Lakes Azuey and Enriquillo (Figure~\ref{figure2}A and Figure~\DIFdelbegin \DIFdel{\ref{figure5}}\DIFdelend \DIFaddbegin \DIFadd{\ref{figure4}}\DIFaddend ). Sonar profiles (Figure~\DIFdelbegin \DIFdel{\ref{figure6}A , B}\DIFdelend \DIFaddbegin \DIFadd{\ref{figure5}A -- D}\DIFaddend ) show that the most recent rupture of the EPGFZ is covered by about 0.7 m of Holocene sediment, suggesting that there has been late Holocene activity of the EPGFZ along the southern edge of the lake.
...
The EPGFZ in both Lake Enriquillo and Lake Azuey is buried by 0.7 m of sediments. According to coring studies in the Dominican Republic \citep{taylor1985stratigraphy,rios2013holocene}, the 5.2 m thickness of the latest lake stage (2 ka BP to present) gives a recent Holocene average sedimentation rate of 2.6 mm/yr (Figure~\DIFdelbegin \DIFdel{\ref{figure4}}\DIFdelend \DIFaddbegin \DIFadd{\ref{figure6}}\DIFaddend B). Using the average sediment rate, the most recent rupture of the EPGFZ would be dated to some 270 years ago. Given the historical earthquake records \citep{bakun2012significant}, we suggest that the most recent rupture of the EPGFZ corresponds to the historical events of October or November 1751 \DIFdelbegin \DIFdel{, and }\DIFdelend \DIFaddbegin \DIFadd{(267 years ago), , and that }\DIFaddend the deformed sediments in Lake Azuey are of Holocene age \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{rios2013holocene}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend .

\subsection{Easternmost extent of the EPGFZ trace in Lake Enriquillo, Dominican Republic}
Based on both of our lake surveys combined with a previous survey of Lake Enriquillo in the Dominican Republic \citep{rios2013holocene}, and the previous geologic mapping of the basinal and topographic corridor of the Cul-de-Sac basin in Haiti and the Enriquillo basin in the Dominican Republic \citep{mann1995actively,mann1999caribbean}, a \DIFdelbegin \DIFdel{first-order }\DIFdelend \DIFaddbegin \DIFadd{basic }\DIFaddend question we pose is whether the EPGFZ extends as a continuous, strike-slip fault along the 120 km-long zone of deformation of Miocene and younger clastic rocks present between the two lakes (Figure~\ref{figure1}B and Figure~\DIFdelbegin \DIFdel{\ref{figure4}}\DIFdelend \DIFaddbegin \DIFadd{\ref{figure6}}\DIFaddend A). \DIFdelbegin \DIFdel{The previous }\DIFdelend \DIFaddbegin \DIFadd{Previous }\DIFaddend studies \citep{saint2015seismotectonics,symithe2016present} have proposed that the EPGFZ terminates as a strike-slip feature in the area south of Port-au-Prince. These studies further have proposed that transpressional plate motion in the eastern Cul-de-Sac basin and the Enriquillo Valley in the Dominican Republic (Figure~\ref{figure1}B and Figure~\DIFdelbegin \DIFdel{\ref{figure4}}\DIFdelend \DIFaddbegin \DIFadd{\ref{figure6}}\DIFaddend A) is entirely accommodated along the low-angle oblique-thrust structures that overthrust the southern edges of Lake Azuey and Lake Enriquillo. 
...
The 2010 aftershock zone at the western and central part of our study area (Figure~\ref{figure7}A) reflects the rupture along the northwest-striking, 20 km-long, submarine, Trois Baies thrust fault that forms the western extension of the 10 -- 15 km-wide, transpressional zone north of the EPGFZ \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{mercier20112010}}\hspace{0pt}%DIFAUXCMD
...
\DIFdelbegin \DIFdel{However}\DIFdelend \DIFaddbegin \DIFadd{Nevertheless}\DIFaddend , the same basic structural elements of the L\'eog\^ane plain are also observed for the \DIFaddbegin \DIFadd{offshore }\DIFaddend Trois Baies thrust fault, which include \DIFdelbegin \DIFdel{the short distance }\DIFdelend \DIFaddbegin \DIFadd{its proximity }\DIFaddend (1 km) to the EPGFZ and its steep ($45^{\circ}$) but opposite (southwest) dip of the Trois Baies thrust fault (Figure~\ref{figure7}). One of the most intense zones of coseismic, aftershock, coastal uplift \citep{hashimoto2011fan}, and subsidence \citep{prentice2010seismic} separates the oppositely-dipping L\'eog\^ane and Trois Baies faults, and may represent complex deformation at a transfer zone between the two\DIFaddbegin \DIFadd{, oppositely-dipping thrust }\DIFaddend faults (Figure~\ref{figure7}A, B). The aftershock study of the Trois Baies fault \citep{symithe2016present} shows that its thrust character and oblique orientation in map view with the main EPGFZ is comparable to the cross sections of the eastern area in Figure~\ref{figure3}. In the map view, the overall structure of this western part of the study area mirrors the same geometrical relationship between the oblique thrusts (such as the Trois Baies thrust fault) and the main EPGFZ as described at the eastern part of the study area (Figure~\ref{figure2}).

\subsection{Structure of the Mirago\^ane pull-apart basin}
In the onshore part of the western study area, Lake Mirago\^ane was interpreted as a 14 km\textsuperscript{2} pull-part basin developed as a left-stepping, releasing bend on the EPGFZ paired with the adjacent Tapion du Petit Go\^ave restraining bend 12 km to the east (Figure~\ref{figure7}) \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citep{cowgill2012interactive}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{mann1995actively,cowgill2012interactive}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend . Bathymetry from our sonar data shows the maximum water depth of Lake Mirago\^ane is 42.8 m (Figure~\ref{figure7}B), which makes this lake the deepest \citep{higuera199910} in the \DIFaddbegin \DIFadd{entire }\DIFaddend Caribbean region. The 30 m of recognizable stratigraphy (Figure \ref{figure8}B and C) from the sonar survey in Lake Mirago\^ane reveals a series of deformational features including major east-west normal faults, minor thrust faults at depth (some 20 m), and active folds at the lake bottom (Figure~\ref{figure8}). The upper 7 m of the lake sediments were cored and dated at 10 ka at the bottom of the core \citep{higuera199910}. By applying the average sedimentary rate from the core data to the chirp sonar trace, we can extrapolate the sedimentation rate to the observed thickness of 30 m in the lake and estimate a minimum of 43 ka for the age of \DIFaddbegin \DIFadd{formation for }\DIFaddend the pull-apart basin \DIFdelbegin \DIFdel{on }\DIFdelend \DIFaddbegin \DIFadd{along }\DIFaddend the EPGFZ. Core measurements of the E/P (evaporation and precipitation ratio from the $\delta^{18}$O of ostracod shells in the core sample) were \DIFdelbegin \DIFdel{undertaken \mbox{%DIFAUXCMD
\citep{higuera199910} }\hspace{0pt}%DIFAUXCMD
in the center of Lake Mirago\^ane }\DIFdelend \DIFaddbegin \DIFadd{carried out \mbox{%DIFAUXCMD
\citep{higuera199910} }\hspace{0pt}%DIFAUXCMD
}\DIFaddend (Figure~\ref{figure9}B). The core reveals that the uppermost part of the sediments are Holocene to the latest Pleistocene in age (Figure~\ref{figure9}A). Pollen data from the core indicate alternating dry and wet environments.

\subsection{Ages and sedimentary cycles of the Mirago\^ane pull-apart basin}
We applied a low-pass filter on the pollen log data (from the core acquired by \citet{higuera199910} in the center of the lake) and found a strong correlation between the pollen and sonar data (red curve in Figure~\ref{figure9}B). To further investigate this interesting correlation between the \DIFdelbegin \DIFdel{geochemical }\DIFdelend \DIFaddbegin \DIFadd{paleoenvironmental }\DIFaddend and geophysical data, we use the filtered E/P log, considered as pseudo-acoustic impedance log, to generate a synthetic sonar response (Figure~\ref{figure9}B). The correlation \DIFdelbegin \DIFdel{is compelling which }\DIFdelend suggests that the \DIFdelbegin \DIFdel{depositional }\DIFdelend \DIFaddbegin \DIFadd{paleodepositional }\DIFaddend environment influences the acoustic properties of the sediments and sonar response may \DIFdelbegin \DIFdel{be }\DIFdelend \DIFaddbegin \DIFadd{serve as }\DIFaddend a partial proxy for climatic processes \DIFdelbegin \DIFdel{. In another words, }\DIFdelend \DIFaddbegin \DIFadd{with }\DIFaddend the sediment layers from drier climates (higher E/P) \DIFdelbegin \DIFdel{have }\DIFdelend \DIFaddbegin \DIFadd{having }\DIFaddend stronger acoustic reflectivity and \DIFdelbegin \DIFdel{vice versa}\DIFdelend \DIFaddbegin \DIFadd{layers from wetter climates having weaker acoustic reflectivity}\DIFaddend . Combining the correlation between the pollen log and the acoustic reflections from the chirp sonar data, we can extend the sedimentary history of the upper 7 m from the log data to the entire sonar data set. 
\DIFaddbegin 

\DIFaddend In the sonar profile, we find the most recent rupture in the lake is buried by about 0.5 meter sediment (Figure~\ref{figure8}B, C). The core dating result from \citet{higuera199910} suggests the age of these rupture is about 300 years old. The historical document record \citep{bakun2012significant} indicates a historical earthquake happened in this area in \DIFdelbegin \DIFdel{1770. }\DIFdelend \DIFaddbegin \DIFadd{1770, or 248 years ago. }\DIFaddend Considering the historical \DIFdelbegin \DIFdel{document }\DIFdelend \DIFaddbegin \DIFadd{earthquake }\DIFaddend record \citep{bakun2012significant}, the dating of the core, and the sonar interpretation in Lake Mirago\^ane \DIFdelbegin \DIFdel{suggest }\DIFdelend \DIFaddbegin \DIFadd{all indicate }\DIFaddend that the most recent rupture in this lake is likely related to the historic earthquake \DIFdelbegin \DIFdel{in }\DIFdelend \DIFaddbegin \DIFadd{of }\DIFaddend 1770 \citep{bakun2012significant}.
...
In summary, our lake studies, along with previous work, favor a model of a 10 -- 15 km-wide transpressional zone that deforms thick, loosely-consolidated, Miocene to recent clastic rocks in coastal, marine, and lake settings as \DIFdelbegin \DIFdel{illustrated in }\DIFdelend \DIFaddbegin \DIFadd{shown schematically in our }\DIFaddend three-dimensional block diagram (Figure~\ref{figure10}). Moving from Lake Azuey in the east to Lake Mirago\^ane in the west, the block diagram illustrates \DIFaddbegin \DIFadd{the }\DIFaddend along-strike \DIFdelbegin \DIFdel{changes }\DIFdelend \DIFaddbegin \DIFadd{alternations in the dips }\DIFaddend observed in the dips of the thrust faults \DIFdelbegin \DIFdel{and obliquely orientation to the EPGFZ . }\DIFdelend \DIFaddbegin \DIFadd{that are oriented in an oblique and }\textit{\DIFadd{en~echelon}} \DIFadd{pattern with the EPGFZ (Figure~\ref{figure10}). EPGFZ. }\DIFaddend Fold axes north of the EPGFZ range from 3 to 20 km in length, and are \DIFdelbegin \DIFdel{sigmoidally related to the }\DIFdelend \DIFaddbegin \DIFadd{sigmoidal in trend with respect to the trace of the }\DIFaddend EPGFZ in map view (Figure~\ref{figure2}A, B). Dip direction and amounts on these thrust faults vary from north-dipping at $21^{\circ}$ on the Jimani fault (Figure~\DIFdelbegin \DIFdel{\ref{figure6}C }\DIFdelend \DIFaddbegin \DIFadd{\ref{figure5}E }\DIFaddend and Figure \ref{figure10}), south-dipping on the \DIFdelbegin \DIFdel{Lamentine }\DIFdelend \DIFaddbegin \DIFadd{Lamentin }\DIFaddend fault \citep{saint2015seismotectonics} at $40^{\circ}$, north-dipping at $70^{\circ}$ on the L\'eog\^ane fault active during the 2010 earthquake (A--A' in Figure~\ref{figure3}, Figure~\ref{figure10}), and south-dipping on the Trois Baies fault at $45^{\circ}$ (Figure~\ref{figure10}). 

South of the EPGFZ, transpressional folding in more rigid Cretaceous basalts and overlying Eocene limestone have broader folding wavelengths from 1 to 8 km and \DIFdelbegin \DIFdel{a weak seismogenic deformation}\DIFdelend \DIFaddbegin \DIFadd{exhibit minor seismicity during and after the 2010 earthquake}\DIFaddend . On the other hand, InSAR images of the 2010 earthquake indicate smaller folds and \DIFaddbegin \DIFadd{much }\DIFaddend more seismogenic deformation in the 10 -- 15 km belt north of the EPGFZ. This \DIFdelbegin \DIFdel{contrast }\DIFdelend \DIFaddbegin \DIFadd{deformational and seismogenic contrast north and south of the EPGFZ }\DIFaddend is likely related to rock type with \DIFdelbegin \DIFdel{poorly consolidated }\DIFdelend \DIFaddbegin \DIFadd{weaker, poorly-consolidated }\DIFaddend sedimentary rocks up to several kilometers north of the EPGFZ and \DIFaddbegin \DIFadd{stronger, }\DIFaddend more consolidated carbonate rocks and basalts exposed in the highlands south of the EPGFZ \citep{mann1991overview} (Figure~\ref{figure2}).

We propose that the folds north of the EPGFZ formed originally as conjugate thrust faults \DIFdelbegin \DIFdel{, reflecting the northeast to southwest convergence }\DIFdelend \DIFaddbegin \DIFadd{within a highly transpressional, tectonic setting }\DIFaddend indicated by GPS vectors \DIFdelbegin \DIFdel{and highly transpressional character of the EPGFZ }\DIFdelend \citep{calais2010transpressional}. Conjugate thrust faults are common in thick, clastic sedimentary basins undergoing active, sub-horizontal shortening \citep{sibson2012reverse}, as documented in the $M_w$ 7.6 Chi-Chi Taiwan earthquake in 1999 \citep{chen2002conjugate} or the $M_w$ 7.1 Kumamoto Japan earthquake in 2016 \citep{lin2017coseismic}. Aftershocks north of the EPGFZ reflect the most recent phase of NE-SW shortening on the $70^{\circ}$ dipping\DIFaddbegin \DIFadd{, conjugate }\DIFaddend reverse fault planes \citep{nettles2010earthquake}, \DIFdelbegin \DIFdel{along }\DIFdelend \DIFaddbegin \DIFadd{of }\DIFaddend the deeply buried L\'eog\^ane thrust fault, as shown in the cross-section of A--A' in Figure~\ref{figure3}.
...
A similar pattern of transpression in a restraining bend setting to Haiti has been described for 1989 $M_w$ 6.9 Loma Prieta earthquake \citep{marshall1991faulting} (Figure~\ref{figure11}). The selected GPS vectors relative to a fixed North America plate \citep{UNAVCO2009} indicate the transpressional setting \DIFdelbegin \DIFdel{in }\DIFdelend \DIFaddbegin \DIFadd{within }\DIFaddend a gentle restraining bend setting. In the inset map of Figure~\ref{figure11}, the 1989 hypocentral area \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citep{marshall1991faulting} }\hspace{0pt}%DIFAUXCMD
shows }\DIFdelend \DIFaddbegin \DIFadd{maps of aftershocks \mbox{%DIFAUXCMD
\citep{marshall1991faulting} }\hspace{0pt}%DIFAUXCMD
reveal }\DIFaddend the steep ($\sim61^{\circ}$) dip of oblique-reverse faults of the collective Sargent and San Andreas faults. \DIFdelbegin \DIFdel{Also, }\DIFdelend \DIFaddbegin \DIFadd{As observed during }\DIFaddend the 1989 \DIFdelbegin \DIFdel{coseismic elevation uplifted }\DIFdelend \DIFaddbegin \DIFadd{earthquake, the southwestward dip of the }\textit{\DIFadd{en~echelon}} \DIFadd{reverse faults produced coseismic uplift up to }\DIFaddend 0.55 m \DIFdelbegin \DIFdel{on the southwestern hanging wall }\DIFdelend \DIFaddbegin \DIFadd{of the lowland areas southwest }\DIFaddend of the San \DIFdelbegin \DIFdel{Andreas and Sargent faults, and subsided }\DIFdelend \DIFaddbegin \DIFadd{Andrea fault and depression by up to }\DIFaddend 0.1 m \DIFdelbegin \DIFdel{on the northeastern footwall block }\DIFdelend \DIFaddbegin \DIFadd{of the mountainous area to the northeast of the San Andreas fault }\DIFaddend \citep{marshall1991faulting}. The thrusting was blind with the $M_w$ 7.1 earthquake not being accompanied by coseismic, surface breaks. \DIFdelbegin \DIFdel{These aftershocks define }\DIFdelend \DIFaddbegin \DIFadd{The pattern of aftershocks (seen on the cross section in Figure~\ref{figure11}) suggest }\DIFaddend a conjugate pair of reverse faults with the dominant motion on the south-dipping fault plane\DIFaddbegin \DIFadd{, similar to the conjugate pair seen on the cross section of the L\'eog\^ane fault as defined by its 2010 aftershocks (cross-section A--A' in Figure~\ref{figure3})}\DIFaddend . 

As in the 2010 $M_w$ 7.0 Haiti earthquake \DIFaddbegin \DIFadd{on the previously unknown L\'eog\^ane thrust}\DIFaddend , a secondary, blind thrust fault \citep{olson1990seismicity} beneath the surface trace of the Sargent fault\DIFdelbegin \DIFdel{that}\DIFdelend , and oblique to the main San Andreas strike-slip fault (shown in inset map of Figure~\ref{figure11}), played a major role in the 1989 fault rupture and resulting pattern of regional uplift shown in red color to the southwest and regional subsidence shown in blue color to the northeast (Figure~\ref{figure11}).

While the oblique \DIFaddbegin \DIFadd{and }\textit{\DIFadd{en~echelon}} \DIFaddend thrust planes form smaller fault segments ranging in length from 3 to 11 km (Figure~\ref{figure2}A), the 2010 \DIFaddbegin \DIFadd{Haiti }\DIFaddend earthquake demonstrates that oblique thrusts like the L\'eog\^ane fault are capable of producing a $M_w$ 7.0 earthquake with devastating results, especially when coupled with inadequate construction practices \citep{symithe2016present}. Paleoseismic estimates of the age of the most recent deformation of Lake Azuey, eastern Haiti, suggests that the latest activity of the EPGFZ in this area was in 1751 \citep{prentice2010seismic,bakun2012significant}. Similar analysis indicates that the latest earthquake event in the Lake Mirago\^ane area, western Haiti, was in 1770 \citep{bakun2012significant}. \DIFdelbegin \DIFdel{This, agreeing the previous study by \mbox{%DIFAUXCMD
\citet{bakun2012significant} }\hspace{0pt}%DIFAUXCMD
, suggest }\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citet{bakun2012significant} }\hspace{0pt}%DIFAUXCMD
conclude that }\DIFaddend the earthquake recurrence cycle along the EPGFZ is about 250 years. Therefore, in \DIFdelbegin \DIFdel{this transpressional setting }\DIFdelend \DIFaddbegin \DIFadd{the highly transpressional setting of Hispaniola}\DIFaddend , the earthquake cycle may consist of \DIFdelbegin \DIFdel{an interplay }\DIFdelend \DIFaddbegin \DIFadd{a complex alternation }\DIFaddend between ruptures on the EPGFZ and ruptures on the oblique\DIFaddbegin \DIFadd{, }\textit{\DIFadd{en~echelon}} \DIFaddend thrusts and related folds. 

The 2010 $M_w$ 7.0 earthquake released part of \DIFdelbegin \DIFdel{the stress of }\DIFdelend \DIFaddbegin \DIFadd{a centuries-long accumulation of stress in }\DIFaddend the region, but as the oblique thrusts may not be directly linked to the EPGFZ, it is \DIFdelbegin \DIFdel{possible }\DIFdelend \DIFaddbegin \DIFadd{likely }\DIFaddend that stresses on the EPGFZ have continued to accumulate since the 18th century \citep{prentice2010seismic}. Integrated paleoseismic study of the EPGFZ with the commonly buried\DIFaddbegin \DIFadd{, }\DIFaddend oblique thrust faults, using geophysical and geologic methods, can help to inform the critical social issue of how future earthquakes will be partitioned between the larger EPGFZ and other more obscure, oblique faults

\section{Conclusions}
The main conclusions of the study are as follows: 

1. High-resolution sonar data from two Haitian lakes that \DIFaddbegin \DIFadd{completely }\DIFaddend straddle the EPGFZ and its northern flank demonstrates the presence of a 10 -- 15 km-wide, 120 km-long, late Holocene, fold-and-thrust belt, which is deforming both the clastic lowland basins along the northern edge of the EPGFZ and the steep topographic highlands to the south. 

2. In the eastern part of the study area, sonar results from Lake Azuey show that the \DIFaddbegin \DIFadd{250--500 m-wide }\DIFaddend EPGFZ is more deeply buried and less active than the adjacent, newly discovered, northwest-striking, northeast-dipping Jimani thrust fault. This structural relationship between the \DIFdelbegin \DIFdel{two faults }\DIFdelend \DIFaddbegin \DIFadd{more deeply buried EPGFZ and more active Jimani thrust fault in Lake Azuey }\DIFaddend is identical to the \DIFdelbegin \DIFdel{2010 epicentral area }\DIFdelend \DIFaddbegin \DIFadd{epicentral area of the 2010 Haiti earthquake }\DIFaddend 70 km to the west: the 2010 seismogenic, L\'eog\^ane blind thrust fault is northwest-to-east-striking, and the quiescent fault to the south during the 2010 earthquake is the east-west-striking, sub-vertical EPGFZ. 

3. The geographic distribution of 2010 aftershocks revealed that the seismogenic motions of the L\'eog\^ane thrust fault and smaller motions on the EPGFZ terminated on a similar northwest-striking fault: the submarine Trois \DIFdelbegin \DIFdel{Bains }\DIFdelend \DIFaddbegin \DIFadd{Baies }\DIFaddend thrust fault. In the westernmost part of the study area, sonar results from Lake Mirogo\^ane show two overlapping and active strands of the EPGFZ, and was instead diverted onto the Trois \DIFdelbegin \DIFdel{Bains }\DIFdelend \DIFaddbegin \DIFadd{Baies }\DIFaddend thrust fault.
...
5.  We interpret this \DIFdelbegin \DIFdel{zone }\DIFdelend \DIFaddbegin \DIFadd{10-15 km-wide, belt }\DIFaddend of late Holocene deformation in clastic basins north of the EPGFZ\DIFaddbegin \DIFadd{, with Cul-de-Sac intermontane basin in the east and the low-relief coastal plain along Port-au-Prince bay and the Canal du Sud to the west, }\DIFaddend as the accommodation of transpressional strain supported by highly-oblique GPS vectors across the study area. In this transpressional zone, coseismic deformation alternates at recurrence intervals of centuries between oblique shortening structures, such as L\'eog\^ane thrusts, Jimani thrusts, and Trois \DIFdelbegin \DIFdel{Bains }\DIFdelend \DIFaddbegin \DIFadd{Baies }\DIFaddend thrusts, and strike-slip ruptures along the narrow and well defined main trace of the EPGFZ.

6. \DIFaddbegin \DIFadd{The presence of }\textit{\DIFadd{en~echelon}} \DIFadd{thrust faults north of the EPGFZ with spacings of 1--8 km and alternating dips are proposed to have formed as a conjugate thrust and reverse faults. The L\'eog\^ane thrust dips to the north along with the newly described Jimani thrust fault dip northeast while other faults like the Trois Baies and Lamartin thrust faults dip to the southwest.  
}

\DIFadd{7. }\DIFaddend Our results, including the eastward extension of the EPGFZ into Dominican Republic, support the ``thick-skinned'' strike-slip model along a 10-15 km-wide corridor of left-lateral shearing centered on the EPGFZ as opposed to the southwestward propagation of the Trans-Haitian fold-and-thrust belt proposed by \citet{pubellier2000plate}.

\acknowledgments
We would like to thank the Society of Exploration Geophysicists' Geoscientists Without Borders program for supporting this project along with our earlier shallow-geophysical imaging of the epicentral region on the L\'eog\^ane fan \citep{kocel2016near}. We also express our appreciation to Alex von Lignau (Haiti Department of Finance), Alfredo Lo Cicero (Oxfam Italia in Haiti) for financial and logistical support on Lake Azuey. \DIFaddbegin \DIFadd{We thank }\DIFaddend Ludner Remarais, and Jean Robert Altidor of the Haiti Bureau of Mines and Energy for their assistance with fieldwork, permissions, and importation of equipment. \DIFaddbegin \DIFadd{We thank }\DIFaddend Eric Fielding of NASA Jet Propulsion Laboratory (JPL)/Caltech for kindly providing the InSAR imagery\DIFdelbegin \DIFdel{. }\DIFdelend \DIFaddbegin \DIFadd{, and }\DIFaddend Roby Douilly of Purdue University for generously providing location information for aftershock data. We are grateful to Allied Geophysical Laboratories (AGL) and William Sager at University of Houston for assisting with equipment and fieldwork preparation. \DIFdelbegin \DIFdel{Last but not least, we sincerely }\DIFdelend \DIFaddbegin \DIFadd{We }\DIFaddend thank Jean-Francois Ritz, an anonymous reviewer, and Marc Jolivet, Tectonics Associate Editor, for their valuable comments and suggestions to improve the quality of the paper. The chirp sonar data used in this paper are available on AGL datastation (http://www.agl.uh.edu/resources-data.php) or by contacting the \DIFdelbegin \DIFdel{corresponding }\DIFdelend \DIFaddbegin \DIFadd{first }\DIFaddend author. 

\clearpage
%\bibliography{Haiti}
\DIFdelbegin %DIFDELCMD < \begin{thebibliography}{59}
%DIFDELCMD < %%%
...
\DIFaddbegin \bibitem[{\textit{Greer and Swart}(2006)}]{greer2006decadal}
\DIFadd{Greer, L., and P.~K. Swart (2006), Decadal cyclicity of regional mid-holocene
  precipitation: Evidence from dominican coral proxies,
  }\textit{\DIFadd{Paleoceanography and Paleoclimatology}}\DIFadd{, }\textit{21}(2)\DIFadd{.
}

\DIFaddend \bibitem[{\textit{Grindlay et~al.}(2005)\textit{Grindlay, Hearne, and
...
\bibitem[{\textit{Leroy et~al.}(2015)\textit{Leroy, Ellouz-Zimmermann, Corbeau,
  Rolandone, L{\'e}pinay, Meyer, Momplaisir, Granja~Bru{\~n}a, Battani, Baurion
  et~al.}}]{leroy2015segmentation}
...
\DIFaddbegin \bibitem[{\textit{Medley et~al.}(2007)\textit{Medley, Tibert, Patterson,
  Curran, Greer, and Colin}}]{medley2007paleosalinity}
\DIFadd{Medley, P., N.~E. Tibert, W.~P. Patterson, H.~A. Curran, L.~Greer, and J.-P.
  Colin (2007), }{\DIFadd{Paleosalinity history of middle Holocene lagoonal and
  lacustrine deposits in the Enriquillo Valley, Dominican Republic based on
  pore morphometrics and isotope geochemistry of ostracoda}}\DIFadd{,
  }\textit{\DIFadd{Micropaleontology}}\DIFadd{, }\textit{53}(5)\DIFadd{, 409--419.
}

\DIFaddend \bibitem[{\textit{Mercier~de L{\'e}pinay et~al.}(2011)\textit{Mercier~de
...
\DIFaddbegin \bibitem[{\textit{Mount and Suppe}(1987)}]{mount1987state}
\DIFadd{Mount, V.~S., and J.~Suppe (1987), State of stress near the san andreas fault:
  Implications for wrench tectonics, }\textit{\DIFadd{Geology}}\DIFadd{, }\textit{15}(12)\DIFadd{,
  1143--1146.
}

\DIFaddend \bibitem[{\textit{Nettles and
...
\caption{\DIFdelbeginFL \textbf{\DIFdelFL{Tectonic setting of the northeastern Caribbean and EPGFZ in southern Haiti.}} %DIFAUXCMD
\DIFdelendFL \DIFaddbeginFL \textbf{\DIFaddFL{Tectonic setting of the northeastern Caribbean and Enriquillo-Plantain Garden fault zone (EPGFZ) in southern Haiti.}} \DIFaddendFL \textbf{A:}
Free-air gravity anomaly map of the Greater Antilles (Cuba, Jamaica, Hispaniola, Puerto Rico) in the northeastern Caribbean (http://topex.ucsd.edu) with gravity lows marking zones of subduction or thrusting along major faults (black lines) of the North America-Caribbean plate boundary. Arrows with error ellipses from \citet{calais2010transpressional} are GPS vectors showing the direction and velocity of the large North American plate, the Bahamas platform\DIFdelbeginFL \DIFdelFL{(}\textbf{\DIFdelFL{BP}}%DIFAUXCMD
\DIFdelFL{)}\DIFdelendFL , and intervening microplates relative to a fixed Caribbean plate. Microplates with variable relative motions occupy the 200 km-wide\DIFaddbeginFL \DIFaddFL{, transpressional, }\DIFaddendFL plate boundary zone and include: \textbf{NHM} = North Hispaniola microplate; \textbf{HM} = Hispaniola microplate; \textbf{GM} = Gon\^ave microplate; \textbf{PRVIM} = Puerto Rico-Virgin Islands microplate. Box shows more detailed map of the EPGFZ shown in B. \textbf{B:} Regional structure map of the southern peninsula of Haiti with the active, left-lateral Enriquillo-Plantain Garden fault zone (EPGFZ) from the Lake Enriquillo in the east to the western tip of the southern peninsula. The centroid moment tensor (CMT) mechanism is from \citet{douilly2013crustal}. From east to west, key lakes and marine embayments aligned parallel and overlying the EPGFZ include: \textbf{LE} = Lake Enriquillo, Dominican Republic; \textbf{LA} = Lake Azuey, Haiti; \textbf{PAPB} = Port-au-Prince Bay; \textbf{CS }= Canal du Sud; \DIFaddbeginFL \textbf{\DIFaddFL{TBF }}\DIFaddFL{= Trois Baies fault; }\DIFaddendFL and \textbf{LM} = Lake Mirago\^ane; \textbf{LF} = L\'eog\^ane fault. Boxes shows more detailed maps of the structure of the EPGFZ and its secondary faults shown in Figure~\ref{figure2}A and Figure~\ref{figure7}A. \textbf{C:} Composite, multichannel seismic reflection line (acquired by Canadian Superior Energy Inc.) located as the red line X-X' in B that shows an unfolded area of high-angle faults in the Canal du Sud tied to the offshore Cul-de-Sac-1 well, the \DIFdelbeginFL \DIFdelFL{TBFZ}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Trois Baies fault}\DIFaddendFL , the EPGFZ, the anticlinal structure of the southern peninsula, and a large, south-verging accretionary prism along the south coast of the southern peninsula. The depth scale for this section is in two-way, travel time.}
\label{figure1}
\end{figure}
...
\caption{\textbf{Structure of the EPGFZ in eastern Haiti. A:} \DIFdelbeginFL \DIFdelFL{Geologic faults }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Faults }\DIFaddendFL and folds along a 15 km-wide corridor parallel to the EPGFZ superimposed on a modified DEM and InSAR surface deformation map (courtesy of Eric Fielding at JPL) \citep{hayes2010complex}. Chirp bathymetry of the Lake Azuey is also shown. GPS vectors are from \citet{calais2010transpressional}. \textbf{PFZ} = Port-au-Prince fault zone; \textbf{DFZ} = Dumay fault zone; \textbf{DT} = Dumay thrust; \textbf{NaC} = Nan Cadastre thrust; \textbf{JFZ} = Jacquet fault zone; \textbf{GFZ} = Ganthier fault zone; \textbf{LF} = L\'eog\^ane fault. Line A -- A': Cross-section along the blind L�og�ne thrust fault (shown in Figure~\ref{figure3}); Line B -- B': Cross-section of north Port-au-Prince urban area (shown in Figure~\ref{figure3}). \textbf{B:} Shaded DEM of the northern deformed belt in the Cul-de-Sac basin with \DIFaddbeginFL \DIFaddFL{North-Eastern }\DIFaddendFL illumination from \DIFdelbeginFL \DIFdelFL{the }\DIFdelendFL Figure~\ref{figure2}A showing \textit{en~echelon} and curvilinear folds striking west-northwest obliquely with respect to the EPGFZ and plunging beneath undeformed sediments occupying the center of the Cul-de-Sac Valley. The \DIFdelbeginFL \DIFdelFL{inserted }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{inset }\DIFaddendFL schematic diagram \DIFaddbeginFL \DIFaddFL{of shearing along a strike-slip fault }\DIFaddendFL is from \citet{odonne1983analogue}\DIFdelbeginFL %DIFDELCMD < }%%%
...
\caption{\DIFdelbeginFL \textbf{\DIFdelFL{Style of late Neogene deformation in the northern belt along three transects shown in Figure~\ref{figure2}.}} %DIFAUXCMD
\DIFdelendFL \DIFaddbeginFL \textbf{\DIFaddFL{Style of late Neogene, transpressional deformation in the northern belt along two transects shown in Figure~\ref{figure2}.}} \DIFaddendFL \textbf{A-A':} Aftershocks of the 2010 earthquake \citep{douilly2013crustal,douilly2015three} along the blind L\'eog\^ane thrust fault reveals conjugate reverse faults with the dominant slip occurring on the north-dipping fault. The red triangle indicates \DIFaddbeginFL \DIFaddFL{the location of }\DIFaddendFL L\'eog\^ane city. \DIFaddbeginFL \DIFaddFL{Coseismic uplift during the 2010 earthquake elevated the northern basinal area and depressed the mountains south of the EPGFZ. }\DIFaddendFL \textbf{B-B':} Cross section based on surface mapping \citep{massoni1955haiti,cox2011shear,mchugh2011offshore,saint2015seismotectonics} showing \DIFaddbeginFL \DIFaddFL{both }\DIFaddendFL north- and south-dipping reverse faults deforming Plio-Pleistocene sedimentary rocks.}
\label{figure3}
\end{figure}

\begin{figure}
\centering
%DIF < \includegraphics[width=\textwidth]{Haiti_figure5}
\includegraphics[width=\textwidth]{Haiti_figure4}
\caption{\textbf{Geologic setting of Lake Azuey, Haiti.} \textbf{A:} To the south, the \DIFdelbeginFL \DIFdelFL{green }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{green-colored, }\DIFaddendFL brackish waters of Lake Azuey are bound by the EPGFZ which forms a sharp boundary with 2 km-high, folded limestone of Paleogene age that forms the smooth surfaces on the skyline. \DIFdelbeginFL \DIFdelFL{One scarp is present along }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{A fault strand of }\DIFaddendFL the \DIFaddbeginFL \DIFaddFL{EPGFZ marks the south }\DIFaddendFL edge of \DIFdelbeginFL \DIFdelFL{the lake }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Lake Azuey }\DIFaddendFL while other parallel strands of the EPGFZ \DIFdelbeginFL \DIFdelFL{are beneath }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{underlie }\DIFaddendFL the southern part of the lake as schematically shown. \textbf{B:} To the north of the lake folded, Plio-Pleistocene strata form the uplifted, 0 -- 30 m-high isthmus \DIFdelbeginFL \DIFdelFL{separating }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{that separates Lake Azuey (15 m ASL) from Lake Enriquillo (46 m BSL) located 1 km to }\DIFaddendFL the \DIFdelbeginFL \DIFdelFL{two lakes}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{east}\DIFaddendFL . Approximate locations of the EPGFZ and the Jimani thrust fault are shown.}
\DIFdelbeginFL %DIFDELCMD < \label{figure5}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \label{figure4}
\DIFaddendFL \end{figure}

\begin{figure}
\centering
%DIF < \includegraphics[width=0.8\textwidth]{Haiti_figure6}
\includegraphics[width=0.8\textwidth]{Haiti_figure5}
\caption{\DIFdelbeginFL \textbf{\DIFdelFL{Chirp sonar profiles showing the relationship of the trace of the EPGFZ and a newly described thrust we have named the Jimani thrust.}} %DIFAUXCMD
\DIFdelendFL \DIFaddbeginFL \textbf{\DIFaddFL{Chirp sonar profiles showing the trace of the EPGFZ in the southern part of Lake Azuey and its relationship with a newly described thrust we have named the Jimani thrust.}} \DIFaddendFL Cross sections of A, \DIFdelbeginFL \DIFdelFL{and }\DIFdelendFL B\DIFaddbeginFL \DIFaddFL{, C, and D }\DIFaddendFL are indicated in Figure~\ref{figure2}A. The EPGFZ beneath Lake Azuey forms a \DIFdelbeginFL \DIFdelFL{10 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{250--500 }\DIFaddendFL m-wide zone that can be traced as a lineament to the east and west of Lake Azuey (Figure~\ref{figure2}). The green and red horizons represent two distinguish stratigraphic layers. The two strands of the EPGFZ are buried by 0.7 m of Holocene sediment and are extrapolated to be 270 years old since their last rupture when \DIFdelbeginFL \DIFdelFL{a }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{an average }\DIFaddendFL sedimentation rate of 2.6 mm/yr \DIFaddbeginFL \DIFaddFL{based on cores from Lake Enriquillo }\DIFaddendFL is assumed. Folds associate with the Jimani thrust are interpreted as fault propagation folds \DIFaddbeginFL \DIFaddFL{above northeast-dipping thrust faults}\DIFaddendFL . \DIFdelbeginFL \textbf{\DIFdelFL{C:}} %DIFAUXCMD
\DIFdelendFL \DIFaddbeginFL \textbf{\DIFaddFL{E:}} \DIFaddendFL Cross section based on both sonar survey and the surface mapping \citep{mann1991overview} showing north- and south-dipping, reverse faults deforming Plio-Pleistocene sedimentary rocks.}
\DIFdelbeginFL %DIFDELCMD < \label{figure6}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \label{figure5}
\DIFaddendFL \end{figure}

\begin{figure}
\centering
%DIF < \includegraphics[width=\textwidth]{Haiti_figure4}
\includegraphics[width=\textwidth]{Haiti_figure6}
\caption{\textbf{Structure of the EPGFZ in eastern Haiti and western-most Dominican Republic.} \textbf{A:} Structural map of Lakes Azuey (surface 15 m ASL) and Lake Enriquillo (surface 46 m BSL) are presently separated by a shallow sill 30 m ASL in the isthmus near the town of Jimani. \textbf{B:} Comparison of two Chirp lines from Lake Enriquillo by \citet{rios2013holocene} (3 km-long Line L19) and from our study of Lake Azuey (4 km-long Line B6). \DIFdelbeginFL \DIFdelFL{Identical }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Similar }\DIFaddendFL sequences present on both lines suggest that the two lakes were once \DIFdelbeginFL \DIFdelFL{part of a single lake that }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{connected and }\DIFaddendFL has been recently separated by crustal movements related to the EPGFZ near the Jimani area \DIFaddbeginFL \DIFaddFL{\mbox{%DIFAUXCMD
\citep{greer2006decadal,medley2007paleosalinity,rios2013holocene}}\hspace{0pt}%DIFAUXCMD
}\DIFaddendFL . Ages of units are known from Lake Enriquillo through both exposures around the sub-sea level lake and from \DIFaddbeginFL \DIFaddFL{lake }\DIFaddendFL coring by \citet{rios2013holocene}.}
\DIFdelbeginFL %DIFDELCMD < \label{figure4}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \label{figure6}
\DIFaddendFL \end{figure}

%DIF < \begin{figure}
%DIF < \centering
%DIF < %\includegraphics[width=\textwidth]{Haiti_figure4}
%DIF < \caption{\textbf{Structure of the EPGFZ in eastern Haiti and western-most Dominican Republic.} \textbf{A:} Structural map of Lakes Azuey (surface 15 m ASL) and Lake Enriquillo (surface 46 m BSL) are presently separated by a shallow sill 30 m ASL in the isthmus near the town of Jimani. \textbf{B:} Comparison of two Chirp lines from Lake Enriquillo by \citet{rios2013holocene} (3 km-long Line L19) and from our study of Lake Azuey (4 km-long Line B6). Identical sequences present on both lines suggest that the two lakes were once part of a single lake that has been recently separated by crustal movements related to the EPGFZ near the Jimani area. Ages of units are known from Lake Enriquillo through both exposures around the sub-sea level lake and from coring by \citet{rios2013holocene}.}
%DIF < \label{figure4}
%DIF < \end{figure}
%DIF < 
%DIF < \begin{figure}
%DIF < \centering
%DIF < %\includegraphics[width=\textwidth]{Haiti_figure5}
%DIF < \caption{\textbf{Geologic setting of Lake Azuey, Haiti.} \textbf{A:} To the south, the green brackish waters of Lake Azuey are bound by the EPGFZ which forms a sharp boundary with 2 km-high, folded limestone of Paleogene age that forms the smooth surfaces on the skyline. One scarp is present along the edge of the lake while other parallel strands of the EPGFZ are beneath the southern part of the lake as schematically shown. \textbf{B:} To the north of the lake folded, Plio-Pleistocene strata form the uplifted, 0 -- 30 m-high isthmus separating the two lakes. Approximate locations of the EPGFZ and the Jimani thrust fault are shown.}
%DIF < \label{figure5}
%DIF < \end{figure}
%DIF < 
%DIF < \begin{figure}
%DIF < \centering
%DIF < %\includegraphics[width=0.8\textwidth]{Haiti_figure6}
%DIF < \caption{\textbf{Chirp sonar profiles showing the relationship of the trace of the EPGFZ and a newly described thrust we have named the Jimani thrust.} Cross sections of A, and B are indicated in Figure~\ref{figure2}A. The EPGFZ beneath Lake Azuey forms a 10 m-wide zone that can be traced as a lineament to the east and west of Lake Azuey (Figure~\ref{figure2}). The green and red horizons represent two distinguish stratigraphic layers. The two strands of the EPGFZ are buried by 0.7 m of Holocene sediment and are extrapolated to be 270 years old since their last rupture when a sedimentation rate of 2.6 mm/yr is assumed.  Folds associate with the Jimani thrust are interpreted as fault propagation folds. \textbf{C:} Cross section based on both sonar survey and the surface mapping \citep{mann1991overview} showing north- and south-dipping, reverse faults deforming Plio-Pleistocene sedimentary rocks.}
%DIF < \label{figure6}
%DIF < \end{figure}
\begin{figure}
\centering
\includegraphics[width=\textwidth]{Haiti_figure7}
\caption{\textbf{Structure and 2010 coseismic surface deformation of the western segments of the EPGFZ.} \textbf{A:} \DIFdelbeginFL \DIFdelFL{Structure }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Fault map }\DIFaddendFL \citep{prentice2010seismic,cowgill2012interactive} and \DIFdelbeginFL \DIFdelFL{aftershock \mbox{%DIFAUXCMD
\citep{douilly2013crustal} }\hspace{0pt}%DIFAUXCMD
}\DIFdelendFL map of \DIFaddbeginFL \DIFaddFL{2010 aftershocks \mbox{%DIFAUXCMD
\citep{douilly2013crustal} }\hspace{0pt}%DIFAUXCMD
in }\DIFaddendFL Mirago\^ane-L\'eog\^ane region overlain with an InSAR image (courtesy of Eric Fielding at JPL) \citep{hayes2010complex}. \textbf{B:} Zoom of the area of Petit Goave and Lake Mirago\^ane showing the structure and bathymetry of the 14 km\textsuperscript{2}, pull-apart basin \DIFdelbeginFL \DIFdelFL{mapped beneath }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{underlying }\DIFaddendFL Lake Mirago\^ane during this study and details of the 2010 surface fracturing and coseismic subsidence in the Petit Go\^ave Bay \DIFdelbeginFL \DIFdelFL{\mbox{%DIFAUXCMD
\citep{prentice2010seismic}}\hspace{0pt}%DIFAUXCMD
}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{\mbox{%DIFAUXCMD
\citep{prentice2010seismic,hornbach2010high}}\hspace{0pt}%DIFAUXCMD
}\DIFaddendFL . \textbf{LM} = Lake Mirago\^ane; \textbf{PG} = Petit Go\^ave.}
\label{figure7}
\end{figure}
...
\caption{\textbf{Geologic setting and sonar profiles from Lake Mirago\^ane.} \textbf{A:} View looking south across the 12 km-wide and 42.8 m deep, freshwater lake. The 2 km-high, ridge along the southern edge of the lake is the cumulative topographic scarp associated \DIFdelbeginFL \DIFdelFL{to }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{with }\DIFaddendFL the southernmost strand of the EPGFZ. The \DIFaddbeginFL \DIFaddFL{7 m-long }\DIFaddendFL core was taken by \citet{higuera199910}\DIFdelbeginFL \DIFdelFL{and }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{, but }\DIFaddendFL was not collected from the deepest part of the lake. \textbf{B:} North-south trending line M1 (location shown on Figure~\ref{figure7}B). \textbf{C:} East-west trending line M5 (location shown on Figure~\ref{figure7}B). \DIFaddbeginFL \DIFaddFL{In the lines shown in }\textbf{\DIFaddFL{B}} \DIFaddFL{and }\textbf{\DIFaddFL{C}}\DIFaddFL{, the strands of the EPGFZ are both buried by 0.5 m of sediment.}\DIFaddendFL }
\label{figure8}
\end{figure}
...
\caption{\textbf{Core data from Lake Mirago\^ane.} \textbf{A:} Tie between chirp sonar and core \DIFaddbeginFL \DIFaddFL{with radiocarbon age control back to 10,230 years BP. }\DIFaddendFL \citep{higuera199910} \DIFdelbeginFL \DIFdelFL{extending }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Cyclicity is related }\DIFaddendFL to \DIFdelbeginFL \DIFdelFL{lacustrine sediments deformed by the EPGFZ }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{changes }\DIFaddendFL in \DIFdelbeginFL \DIFdelFL{1770 A}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{lithology related to alternating wet and dry periods as shown}\DIFaddendFL . \DIFdelbeginFL \DIFdelFL{D}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Yellow areas are shallow marine to freshwater and green areas contain wood debris and may mark a period when the lake was dry}\DIFaddendFL . \DIFdelbeginFL \DIFdelFL{. }\DIFdelendFL \textbf{B:} Low-pass filtered E/P log (red) and the synthetic sonar profile generated from the low-pass filtered E/P log used as an acoustic impedance. The chirp sonar profiles are from the location of the red bar in the Figure~\ref{figure8}B, C.}
\label{figure9}
\end{figure}
...
\caption{\DIFdelbeginFL \textbf{\DIFdelFL{Schematic diagram of the conjugate-thrust-fault model for the 10 -- 15 km-wide belt of transpressional deformation along the northern edge of the EPGFZ. A:}} %DIFAUXCMD
\DIFdelendFL \DIFaddbeginFL \textbf{\DIFaddFL{Schematic diagram of the conjugate-thrust-fault model for the 10--15 km-wide belt of transpressional deformation along the northern edge of the EPGFZ. A:}} \DIFaddendFL Three-dimensional block diagram showing the structural, aftershocks, and the late Holocene strain partitioning in a 40-km-wide zone along a 120 km-long segment of the EPGFZ. Black arrows show \DIFaddbeginFL \DIFaddFL{the }\DIFaddendFL southwest direction of the \DIFdelbeginFL \DIFdelFL{Gon\^ave microplate }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{GPS vectors }\DIFaddendFL relative to the Caribbean plate \citep{calais2010transpressional}. The 2010 InSAR-derived surface deformation map (\DIFdelbeginFL \DIFdelFL{courtesy of }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{provided by }\DIFaddendFL Eric Fielding at JPL) \citep{hayes2010complex} \DIFdelbeginFL \DIFdelFL{show }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{shows }\DIFaddendFL a large component of shortening accommodated on a 40 km-wide zone of oblique thrusts and folds north of the EPGFZ. \DIFaddbeginFL \DIFaddFL{Aftershock pattern shown in the cross section show that the northeastward dip of the }\textit{\DIFaddFL{en~echelon}}\DIFaddFL{. L\'eog\^ane thrust adjacent to the EPGFZ uplifted the topographically-lower, basinal area to the north of the EPGFZ and depressed the mountainous area to the south of the EPGFZ. The alternating dip of the }\textit{\DIFaddFL{en~echelon}} \DIFaddFL{thrusts is related to their origin as conjugate thrust faults in a highly transpressional setting. }\DIFaddendFL \textbf{PaP} = Port-au-Prince; \textbf{PG} = Petit Goave; \textbf{LA} = Lake Azuey; \textbf{LM} = Lake Mirago\^ane-L\'eog\^ane; \textbf{JF} = Jimani thrust fault; \textbf{DT} = Dumay thrust; \textbf{PFZ} = Port-au-Prince fault zone; \textbf{LMF} = Lamartin thrust fault; \textbf{TBF} = Trois Baies thrust fault; \textbf{LF} = L\'eog\^ane fault. \textbf{B:} Schematic diagram, modified from \citet{sibson2012reverse}, of the conjugate thrust faults.}
\label{figure10}
\end{figure}
...
\caption{\DIFdelbeginFL \textbf{\DIFdelFL{Structural map of the southern San Francisco Bay region, the cos-seismic elevation and the aftershock cross-section of 1989 $M_w$ 6.9  Loma Prieta earthquake.}} %DIFAUXCMD
\DIFdelendFL \DIFaddbeginFL \textbf{\DIFaddFL{Structural map of the southern San Francisco Bay region, the co-seismic elevation and the aftershock cross-section of 1989 $M_w$ 6.9  Loma Prieta earthquake.}} \DIFaddendFL The selected GPS vectors relative to a fixed North America plate are from \citet{UNAVCO2009}. The \DIFdelbeginFL \DIFdelFL{cos-seismic }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{coseismic }\DIFaddendFL elevation change and aftershock cross-section are modified from \citet{marshall1991faulting}. \textbf{SAF}: San Andreas Fault; \textbf{SF}: Sargent Fault\DIFaddbeginFL \DIFaddFL{. Aftershock pattern in the cross-section shows that the southwest dip of the }\textit{\DIFaddFL{en~echelon}} \DIFaddFL{thrust adjacent to the San Andreas fault uplifted the topographically-lower basinal area and depressed the mountainous area to the northeast of the San Andreas fault}\DIFaddendFL .}
\label{figure11}
\end{figure}
